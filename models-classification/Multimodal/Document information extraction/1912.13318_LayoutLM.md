...
<sup>1</sup><https://sites.google.com/view/di2019>**ACUTE TOXICITY IN MICE**

Compound: 4-Butoxo-3-methylbutanoic acid (Tyr 13)  
 Study: Forfiliars - Organic Chemistry CR39-23  
 Date Received: 12/28/78 Reopened: 10/4/80, Update  
 Investigator: N. S. Jones & M. S. Foster Reference: B1014-23  
 Contract: 7-1-78 to 12-31-78 (by Dr. J. L. H. (Ray) Parker)

Field of study: Soles-Webster Inst. X Research Unk.  
 Testing Method: Test Unk. Research Unk.  
 Type of Compound Administration: Oral Topical Inhalation  
 Compound Vehicle: 5% solution (saline) 100% 100% 0.1% 0.01%
...
Reviewed for Calculation: Litchfield, J. T. and Wilcoxin, P. J. of Pharmacol. and Exper. Ther., 1939, 104.  
 Toxicity Comments: 3.5 hrs to 3 days  
 Toxicity Data: Compound appears to act as a CNS depressant with symptoms of respiratory depression, constriction of blood vessels, and inactivity. Survivors recovered in 48 hours. The recommended safe dose for a single trial by inhalation in man is 0.1 mg.

Copies to the following: Dr. E. J. McInerney  
Mr. T. M. Gray
...
DATE: 12/19/80 AUTHORIZATION NO.: NY-75

PROJECT NAME: ORPHI ANALOGS: ACTIVITY & TOXIC ANALYSIS - GENERAL  
 SUPPLIER: KEYE MARKETING RESEARCH

PREVIOUS 5. COMMITMENTS TO THE PROJECT: \$ 220,000  
 AMOUNT OF CHANGE (INCREASE/DECREASE): \$ 71,000 (0.5 % CHANGE)  
 REASON: INCREASE (One)

AMOUNTED TOTAL COST OF PROJECT: \$ 291,000

REASON: INTENDED COST WAS TO A QUESTION ARISE BY THE SECOND DATE AND CHANGE MADE IN MISSING OF OTHER QUESTIONS. THIS COVERS THE COST OF ADDITIONAL TELEPHONE ATTENDANT SERVICE, COSTS OF THE OFFICES, PROGRAMMING CHARGES, RADIATION AND ANALYSIS.
...
<th>PROCESSED:</th>
<th>DATE:</th>
<th>TOTAL AREA BUDGET (RECEIVED)</th>
</tr>
</thead>
<tbody>
<tr>
...
<td></td>
<td></td>
<td>NEW BALANCE: 1,652,794.66</td>
</tr>
</tbody>
</table>

CORRECTED TO DATE: 1,652,794.66  
 (Current Year)

SUBMITTED BY: [Signature] DATE: 12/19/80  
 APPROVED BY: [Signature] DATE: 12/19/80  
 APPROVED BY: [Signature] DATE: 12/19/80  
 APPROVED BY: [Signature] DATE: 12/19/80

ORIGINAL - PROJECT FILE  
 CC: S. Willinger (CV) PROJECT NO. 1384-3709  
Research Group Manager Account Dept. 651025147

(b)

ADDITION 1 MAY 26 1981

BAKER RESEARCH CORPORATION  
 Protocol Change Order No. 1

Protocol LMC-5A Date: 5-13-81  
 Subject: Change in the time of the Pre-Dose Nucleosomic Examination
...
Description of change order:  
 Section III, A. 2<sup>nd</sup> paragraph - the first sentence is to be changed to read as follows:  
 Twenty-four to 36 hours prior to dosing, both eyes of each rabbit will be examined by an experienced investigator using a slit lamp slitlamp.

The change was made so the protocol more closely conforms with the proposed regulations as stated in the Federal Register, Vol. 46, No. 187, 77:113-24 Primary Eye Irritation Study.

Signature: [Signature] Study Director Signature
...
**GENERAL INFORMATION:**  
 EVENT NAME: Beach Vacation - Jersey Festival  
 EVENT LOCATION: Beach, Jersey, New Jersey, NJ  
 EVENT DATES: June 4, 1980

**HOURS:**  
 MONDAY-SUNDAY: \_\_\_\_\_  
 SATURDAY-SUNDAY: 11:00 am - 4 pm
...
<sup>3</sup><https://guillaumejeaume.github.io/FUNSD/>

<sup>4</sup><https://rrc.cvc.uab.es/?ch=13>

<sup>5</sup><https://www.cs.cmu.edu/~aharley/rvl-cdip/>

<sup>2</sup><https://ir.nist.gov/cdip/>The diagram illustrates the LayoutLM architecture. It starts with a document image on the right, which is processed by a **Pre-built OCR/PDF Parser**. This parser outputs **Text Embeddings** (e.g.,  $E_{[[CLS]]}$ ,  $E_{Date}$ ,  $E_{Routed:}$ ,  $E_{January}$ ,  $E_{11.}$ ,  $E_{1994}$ ,  $E_{Contract}$ ,  $E_{No.}$ ,  $E_{4011}$ ,  $E_{0000}$ ), **Position Embeddings** (x0, y0, x1, y1), and an **ROI**. The **Position Embeddings** are combined with **Image Embeddings** and **LayoutLM Embeddings** to form a sequence of tokens:  $[CLS]$ ,  $+$ ,  $Date$ ,  $+$ ,  $Routed:$ ,  $+$ ,  $January$ ,  $+$ ,  $11.$ ,  $+$ ,  $1994$ ,  $+$ ,  $Contract$ ,  $+$ ,  $No.$ ,  $+$ ,  $4011$ ,  $+$ ,  $00 00$ . This sequence is then processed by a **Pre-trained LayoutLM**, followed by **FC Layers**, and finally a **Faster R-CNN** for downstream tasks.
...
<sup>6</sup><https://github.com/tesseract-ocr/tesseract><table border="1">
<thead>
<tr>
<th>Modality</th>
<th>Model</th>
...
<tr>
<td rowspan="4">Text + Layout<br/>MVLM</td>
<td>LayoutLM<sub>BASE</sub> (500K, 6 epochs)</td>
<td>0.665</td>
<td>0.7355</td>
<td>0.6985</td>
<td>113M</td>
...
<tr>
<td>LayoutLM<sub>BASE</sub> (1M, 6 epochs)</td>
<td>0.6909</td>
<td>0.7735</td>
<td>0.7299</td>
<td>113M</td>
...
<tr>
<td>LayoutLM<sub>BASE</sub> (2M, 6 epochs)</td>
<td>0.7377</td>
<td>0.782</td>
<td>0.7592</td>
<td>113M</td>
...
<tr>
<td>LayoutLM<sub>BASE</sub> (11M, 2 epochs)</td>
<td>0.7597</td>
<td>0.8155</td>
<td>0.7866</td>
<td>113M</td>
...
<tr>
<td rowspan="2">Text + Layout<br/>MVLM+MDC</td>
<td>LayoutLM<sub>BASE</sub> (1M, 6 epochs)</td>
<td>0.7076</td>
<td>0.7695</td>
<td>0.7372</td>
...
<tr>
<td>LayoutLM<sub>BASE</sub> (11M, 1 epoch)</td>
<td>0.7194</td>
<td>0.7780</td>
<td>0.7475</td>
<td>113M</td>
...
<tr>
<td rowspan="2">Text + Layout<br/>MVLM</td>
<td>LayoutLM<sub>LARGE</sub> (1M, 6 epochs)</td>
<td>0.7171</td>
<td>0.805</td>
<td>0.7585</td>
<td>343M</td>
...
<tr>
<td>LayoutLM<sub>LARGE</sub> (11M, 1 epoch)</td>
<td>0.7536</td>
<td>0.806</td>
<td>0.7789</td>
<td>343M</td>
...
<tr>
<td rowspan="2">Text + Layout + Image<br/>MVLM</td>
<td>LayoutLM<sub>BASE</sub> (1M, 6 epochs)</td>
<td>0.7101</td>
<td>0.7815</td>
<td>0.7441</td>
...
<tr>
<td>Baseline</td>
<td>Ranking 1<sup>st</sup> in SROIE</td>
<td>0.9402</td>
<td>0.9402</td>
<td>0.9402</td>
<td>-</td>
...
<tr>
<td rowspan="7">Baselines</td>
<td>VGG-16 [1]</td>
<td>90.97%</td>
<td>-</td>
</tr>
<tr>
<td>Stacked CNN Single [2]</td>
<td>91.11%</td>
<td>-</td>
</tr>
<tr>
<td>Stacked CNN Ensemble [2]</td>
<td>92.21%</td>
<td>-</td>
</tr>
<tr>
<td>InceptionResNetV2 [25]</td>
<td>92.63%</td>
<td>-</td>
</tr>
<tr>
...
<tr>
<td>Multimodal Single [3]</td>
<td>93.03%</td>
<td>-</td>
</tr>
<tr>
<td>Multimodal Ensemble [3]</td>
<td>93.07%</td>
<td>-</td>
</tr>
</tbody>
...
1. [1] Muhammad Zeshan Afzal, Andreas Kölsch, Sheraz Ahmed, and Marcus Liwicki. 2017. Cutting the Error by Half: Investigation of Very Deep CNN and Advanced Training Strategies for Document Image Classification. *2017 14th IAPR International Conference on Document Analysis and Recognition (ICDAR)* 01 (2017), 883–888.
2. [2] Arindam Das, Saikat Roy, and Ujjwal Bhattacharya. 2018. Document Image Classification with Intra-Domain Transfer Learning and Stacked Generalization of Deep Convolutional Neural Networks. *2018 24th International Conference on Pattern Recognition (ICPR)* (2018), 3180–3185.
3. [3] Tyler Dauphinee, Nikunj Patel, and Mohammad Mehdi Rashidi. 2019. Modular Multimodal Architecture for Document Classification. *ArXiv abs/1912.04376* (2019).
4. [4] Jacob Devlin, Ming-Wei Chang, Kenton Lee, and Kristina Toutanova. 2019. BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding. In *Proceedings of the 2019 Conference of the North American Chapter of the Association for Computational Linguistics: Human Language Technologies, Volume 1 (Long and Short Papers)*. Association for Computational Linguistics, Minneapolis, Minnesota, 4171–4186. <https://doi.org/10.18653/v1/N19-1423>
5. [5] Jaekyu Ha, Robert M Haralick, and Ihsin T Phillips. 1995. Document page decomposition by the bounding-box project. In *Proceedings of 3rd International Conference on Document Analysis and Recognition*, Vol. 2. IEEE, 1119–1122.
6. [6] Jaekyu Ha, Robert M Haralick, and Ihsin T Phillips. 1995. Recursive XY cut using bounding boxes of connected components. In *Proceedings of 3rd International Conference on Document Analysis and Recognition*, Vol. 2. IEEE, 952–955.
7. [7] Leipeng Hao, Liangcai Gao, Xiaohan Yi, and Zhi Tang. 2016. A Table Detection Method for PDF Documents Based on Convolutional Neural Networks. *2016 12th IAPR Workshop on Document Analysis Systems (DAS)* (2016), 287–292.
8. [8] Adam W Harley, Alex Ufkes, and Konstantinos G. Derpanis. 2015. Evaluation of deep convolutional nets for document image classification and retrieval. *2015 13th International Conference on Document Analysis and Recognition (ICDAR)* (2015), 991–995.
9. [9] Kaiming He, Georgia Gkioxari, Piotr Dollár, and Ross B. Girshick. 2017. Mask R-CNN. *CoRR abs/1703.06870* (2017). [arXiv:1703.06870](http://arxiv.org/abs/1703.06870) <http://arxiv.org/abs/1703.06870>
10. [10] Guillaume Jaume, Hazim Kemal Ekenel, and Jean-Philippe Thiran. 2019. FUNSD: A Dataset for Form Understanding in Noisy Scanned Documents. *2019 International Conference on Document Analysis and Recognition Workshops (ICDARW)* 2 (2019), 1–6.
11. [11] Anoop R Katti, Christian Reisswig, Cordula Guder, Sebastian Brarda, Steffen Bickel, Johannes Höhne, and Jean Baptiste Faddoul. 2018. CharGrid: Towards Understanding 2D Documents. In *Proceedings of the 2018 Conference on Empirical Methods in Natural Language Processing*. Association for Computational Linguistics, Brussels, Belgium, 4459–4469. <https://doi.org/10.18653/v1/D18-1476>
12. [12] Ranjay Krishna, Yuke Zhu, Oliver Groth, Justin Johnson, Kenji Hata, Joshua Kravitz, Stephanie Chen, Yanns Kalantidis, Li-Jia Li, David A Shamma, Michael Bernstein, and Li Fei-Fei. 2016. Visual Genome: Connecting Language and Vision Using Crowdsourced Dense Image Annotations. <https://arxiv.org/abs/1602.07332>
13. [13] Frank Lebourgeois, Z Bublinski, and H Emptoz. 1992. A fast and efficient method for extracting text paragraphs and graphics from unconstrained documents. In *Proceedings, 11th IAPR International Conference on Pattern Recognition. Vol. II. Conference B: Pattern Recognition Methodology and Systems*. IEEE, 272–276.
14. [14] D. Lewis, G. Agam, S. Argamon, O. Frieder, D. Grossman, and J. Heard. 2006. Building a Test Collection for Complex Document Information Processing. In *Proceedings of the 29th Annual International ACM SIGIR Conference on Research and Development in Information Retrieval* (Seattle, Washington, USA) (SIGIR '06). ACM, New York, NY, USA, 665–666. <https://doi.org/10.1145/1148170.1148307>
15. [15] Xiaojing Liu, Feiyu Gao, Qiong Zhang, and Huasha Zhao. 2019. Graph Convolution for Multimodal Information Extraction from Visually Rich Documents. In *Proceedings of the 2019 Conference of the North American Chapter of the Association for Computational Linguistics: Human Language Technologies, Volume 2 (Industry Papers)*. Association for Computational Linguistics, Minneapolis, Minnesota, 32–39. <https://doi.org/10.18653/v1/N19-2005>
16. [16] Yinhan Liu, Myle Ott, Naman Goyal, Jingfei Du, Mandar Joshi, Danqi Chen, Omer Levy, Mike Lewis, Luke S. Zettlemoyer, and Veselin Stoyanov. 2019. RoBERTa: A Robustly Optimized BERT Pretraining Approach. *ArXiv abs/1907.11692* (2019).
17. [17] S. Marini, M. Gori, and G. Soda. 2005. Artificial neural networks for document analysis and recognition. *IEEE Transactions on Pattern Analysis and Machine Intelligence* 27, 1 (Jan 2005), 23–35. <https://doi.org/10.1109/TPAMI.2005.4>
18. [18] L. O’Gorman. 1993. The document spectrum for page layout analysis. *IEEE Transactions on Pattern Analysis and Machine Intelligence* 15, 11 (Nov 1993), 1162–1173. <https://doi.org/10.1109/34.244677>
19. [19] Shaoqing Ren, Kaiming He, Ross B. Girshick, and Jian Sun. 2015. Faster R-CNN: Towards Real-Time Object Detection with Region Proposal Networks. *IEEE Transactions on Pattern Analysis and Machine Intelligence* 39 (2015), 1137–1149.
20. [20] Ritesh Sarkhel and Arnab Nandi. 2019. Deterministic Routing between Layout Abstractions for Multi-Scale Classification of Visually Rich Documents. In *Proceedings of the Twenty-Eighth International Joint Conference on Artificial Intelligence, IJCAI-19*. International Joint Conferences on Artificial Intelligence Organization, 3360–3366. <https://doi.org/10.24963/ijcai.2019/466>
21. [21] Sebastian Schreiber, Stefan Agne, Ivo Wolf, Andreas Dengel, and Sheraz Ahmed. 2017. DeepDeSRT: Deep Learning for Detection and Structure Recognition of Tables in Document Images. *2017 14th IAPR International Conference on Document Analysis and Recognition (ICDAR)* 01 (2017), 1162–1167.
22. [22] Michael Shilman, Percy Liang, and Paul Viola. 2005. Learning nongenerative grammatical models for document analysis. In *Tenth IEEE International Conference on Computer Vision (ICCV'05) Volume 1*, Vol. 2. IEEE, 962–969.
23. [23] Anikó Simon, J-C Pret, and A Peter Johnson. 1997. A fast algorithm for bottom-up document layout analysis. *IEEE Transactions on Pattern Analysis and Machine Intelligence* 19, 3 (1997), 273–277.
24. [24] Carlos Soto and Shinjae Yoo. 2019. Visual Detection with Context for Document Layout Analysis. In *Proceedings of the 2019 Conference on Empirical Methods in Natural Language Processing and the 9th International Joint Conference on Natural Language Processing (EMNLP-IJCNLP)*. Association for Computational Linguistics, Hong Kong, China, 3462–3468. <https://doi.org/10.18653/v1/D19-1348>
25. [25] Christian Szegedy, Sergey Ioffe, Vincent Vanhoucke, and Alex Alemi. 2016. Inception-v4, Inception-ResNet and the Impact of Residual Connections on Learning. In *AAAI*.
26. [26] Matheus Palhares Viana and Dário Augusto Borges Oliveira. 2017. Fast CNN-Based Document Layout Analysis. *2017 IEEE International Conference on Computer Vision Workshops (ICCVW)* (2017), 1173–1180.
27. [27] H. Wei, M. Baechler, F. Slimane, and R. Ingold. 2013. Evaluation of SVM, MLP and GMM Classifiers for Layout Analysis of Historical Documents. In *2013 12th International Conference on Document Analysis and Recognition*. 1220–1224. <https://doi.org/10.1109/ICDAR.2013.247>
28. [28] Xiaowei Yang, Ersin Yumer, Paul Asente, Mike Kraley, Daniel Kifer, and C. Lee Giles. 2017. Learning to Extract Semantic Structure from Documents Using Multimodal Fully Convolutional Neural Networks. *2017 IEEE Conference on Computer Vision and Pattern Recognition (CVPR)* (2017), 4342–4351.
29. [29] Xu Zhong, Jianbin Tang, and Antonio Jimeno-Yepes. 2019. PubLayNet: largest dataset ever for document layout analysis. *ArXiv abs/1908.07836* (2019).
